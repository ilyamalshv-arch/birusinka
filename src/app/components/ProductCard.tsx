    ...
    <article className="group relative mx-auto flex w-full max-w-[420px] cursor-pointer flex-col items-center gap-[7px] rounded-[30px] bg-white transition-shadow duration-200 hover:shadow-[0_10px_30px_rgba(0,0,0,0.10)] min-[768px]:pb-[27px] max-[767px]:gap-[3px] max-[767px]:rounded-[8px] max-[767px]:pb-[10px]">
      <div className="relative aspect-[410/392] w-[calc(100%_-_10px)] overflow-hidden rounded-[30px] max-[767px]:aspect-[140/141] max-[767px]:w-[calc(100%_-_20px)] max-[767px]:rounded-[11px]">
        ...
        <div className="absolute inset-x-[20px] top-0 flex h-[89px] items-center justify-between max-[767px]:inset-x-[8px] max-[767px]:h-[40px]">
          ...
          {tag && (
            <span className="flex h-[28px] items-center rounded-[5px] bg-tag px-[20px] text-[16px] font-medium leading-[156%] text-white max-[767px]:h-[11px] max-[767px]:rounded-[2px] max-[767px]:px-[7px] max-[767px]:text-[6px]">
              {tag}
            </span>
          )}
        </div>
      ...
      <div className="flex w-[calc(100%_-_50px)] items-start justify-between gap-[10px] min-[768px]:min-h-[64px] max-[767px]:w-[calc(100%_-_20px)] max-[767px]:gap-[4px]">
        <p
          className={`${montserratAlt.className} flex-1 whitespace-pre-line text-[24px] font-medium leading-[104%] text-ink max-[767px]:text-[12px] max-[767px]:leading-[15px]`}
        >
          {title}
        </p>
        <Image
      ...
      <div className="flex w-[calc(100%_-_10px)] items-center justify-between px-[20px] max-[767px]:w-[calc(100%_-_20px)] max-[767px]:px-0">
        <button
          type="button"
          aria-label="Купить"
          className="flex items-center gap-[9px] rounded-[8px] bg-ink p-[10px] text-[24px] font-medium leading-[29px] text-white transition hover:brightness-125 max-[767px]:gap-[3px] max-[767px]:rounded-[4px] max-[767px]:px-[5px] max-[767px]:py-[4px] max-[767px]:text-[10px]"
        >
          <span>{price}</span>
          <Image
